...
const BilliardsI18N = (() => {
  ...
  const DICT = {
    ja: {
      ...
      'msg.golfScratch': '手玉を落としました（1打罰）。玉は撞く前の場所へ戻り、相手が手玉を自由に置けます',
    ...
    en: {
      ...
      'msg.golfScratch': 'Cue ball lost - one penalty stroke; you replay from where you were, and your opponents get ball in hand.',
    ...
    zh: {
      ...
      'msg.golfScratch': '母球落袋（罚一杆）。球退回击球前的位置，由对手自由摆放母球。',
