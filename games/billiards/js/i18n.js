...
const BilliardsI18N = (() => {
  ...
  const DICT = {
    ja: {
      ...
      'msg.golfScratch': '手玉を落としました（1打罰）。好きな場所へ置けます',
    ...
    en: {
      ...
      'msg.golfScratch': 'Cue ball lost - one penalty stroke; place it anywhere.',
    ...
    zh: {
      ...
      'msg.golfScratch': '母球落袋（罚一杆），可自由摆放。',
