...
export const en: LocaleData = {
  ...
  translations: {
    ...
    's00.mReview': 'Review',
    "s00.mReviewD": "Replay a finished game and try any move from any position. This starts on your own — to join someone else's review, go to Online match.",
    ...
    's11.roomHowToJoin': 'They join from the Online match room list',
