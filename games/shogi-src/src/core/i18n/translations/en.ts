...
export const en: LocaleData = {
  ...
  translations: {
    ...
    's00.lead': "Pick how you want to play. You'll choose the rule and modifiers on the next screen.",
    ...
    's00.footDesc': 'MOMO Shogi is a free Shogi game you can play in your browser. Beyond standard Shogi, play offbeat variants like the torus board — where the edges wrap around — and Quantum Shogi, where a piece\'s true identity stays undecided. It supports online matches against other players as well as games against the AI. No account or installation required — just play instantly in your browser.',
