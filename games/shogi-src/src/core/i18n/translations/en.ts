...
export const en: LocaleData = {
  ...
  translations: {
    ...
    'result.detail.pointsLabel': 'Points',
    'result.detail.method.27point': ' (27-point rule)',
    'result.detail.method.24point': ' (24-point rule)',
    'result.detail.zonePieces': 'In enemy zone (excl. king)',
    'result.detail.zoneMajors': 'Major pieces in zone',
    'result.detail.sentePoints': 'Sente points',
    'result.detail.gotePoints': 'Gote points',
    'result.detail.scope': 'Counted',
    'result.detail.scopeJishogi': 'All pieces on board + in hand',
    'result.detail.countRule': 'Per piece',
    'result.detail.countRuleValue': 'Major 5, minor 1 (excl. king)',
