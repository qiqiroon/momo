...
export const en: LocaleData = {
  ...
  translations: {
    ...
    's02.qmFairBold': 'The mode you pick sets the baseline for the game.',
    's02.qmFairRest': 'With Cycle, your opponent and spectators may switch their own screen to Stack (making it harder is up to them). With Stack, everyone stays on Stack. Nobody gets an easier-to-read view than you chose.',
    ...
    'settings.hintDesc': 'Tint reachable squares orange',
