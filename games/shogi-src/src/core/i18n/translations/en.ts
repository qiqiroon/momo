...
export const en: LocaleData = {
  ...
  translations: {
    ...
    // Pause/Resume (Phase 2-8 v0.41)
    'cmd.resume': 'Resume',
    'pause.receivedTitle': 'Pause Request',
    'pause.receivedBody': 'Your opponent is requesting to pause the game. Both clocks will stop if you agree.',
    'pause.acceptAction': 'Agree to pause',
    'pause.rejectAction': 'Decline pause',
    'pause.sentWaiting': 'Pause requested — waiting for response',
    'pause.rejectedByOpp': 'Opponent declined the pause',
    'resume.receivedTitle': 'Resume Request',
    'resume.receivedBody': 'Your opponent is requesting to resume the game. Clocks will start again if you agree.',
    'resume.acceptAction': 'Agree to resume',
    'resume.rejectAction': 'Decline resume',
    'resume.sentWaiting': 'Resume requested — waiting for response',
