...
export const en: LocaleData = {
  ...
  translations: {
    ...
    'app.ver': 'v0.57',
    // S02 rule selection (mock S02_v2 origin, v0.57)
    's02.screenTitle': 'Choose Rule',
    's02.secRules': 'Game rule',
    's02.secMods': 'Modifiers (stackable)',
    ...
    's04.public': 'List publicly',
    's04.createRoom': 'Create room',
    's04.summaryMods': 'Modifiers',
