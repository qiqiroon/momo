...
export const en: LocaleData = {
  ...
  translations: {
    ...
    // ★段2: recover a custom rule definition from a file (§9.2.6 ②)
    's08.ruleFile.title': 'Rule definition needed',
    's08.ruleFile.body': "This kifu's rule is not built into the app. Please choose its definition file.",
    's08.ruleFile.rule': 'Rule',
    's08.ruleFile.version': 'Version',
    's08.ruleFile.choose': 'Choose definition file',
    's08.ruleFile.cancel': 'Cancel',
    ...
    's08.ruleFile.rechoose': 'Choose another file',
    's08.ruleFile.abort': 'Stop',
    ...
    'result.reason.jishogi': 'Jishogi (impasse draw)',
    ...
    'result.detail.sep': ', ',
    'result.detail.remainingSente': 'Sente pieces left',
    'result.detail.remainingGote': 'Gote pieces left',
    'result.detail.winCondition': 'Win condition',
    // v1.87: show the sum as a formula, not just the total (appendix D-3 v1.11 §3.4).
    'result.detail.formula': 'major 5 x {M} + minor 1 x {m} (less 1 king) = {P} pts',
    'result.detail.formulaNoKing': 'major 5 x {M} + minor 1 x {m} = {P} pts',
    'result.detail.sideEntered': '{side}: king entered, {formula}',
    'result.detail.sideLine': '{side}: {formula}',
    'result.detail.condEntered': 'King has entered',
    'result.detail.condPieces': 'Pieces in enemy zone {n} >= {need}',
    'result.detail.condPoints': 'Points {p} >= {need}',
    'result.detail.condPointsMethod': 'Points {p} >= {need} ({method})',
    'result.detail.method.27point': '27-point rule',
    'result.detail.method.24point': '24-point rule',
    'result.detail.zoneMajors': 'Major pieces in zone',
    'result.detail.scope': 'Counted',
    'result.detail.scopeJishogi': 'All pieces on board + in hand',
    'result.detail.scopeEnter': 'Pieces in enemy zone + in hand',
    ...
    'jishogi.receivedTitle': 'Jishogi Offer',
    'jishogi.receivedBody': 'Your opponent offers jishogi (impasse draw).',
    'jishogi.acceptAction': 'Accept',
    'jishogi.rejectAction': 'Decline',
    'jishogi.sentWaiting': 'Jishogi offered',
    'jishogi.spectatorNotice': 'Jishogi offer pending',
    'draw.rejectedByOpp': 'Opponent declined the draw',
    'jishogi.notAgreed': 'Jishogi was not agreed',
