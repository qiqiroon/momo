...
export const ja: LocaleData = {
  ...
  translations: {
    ...
    // 中断・再開 (段階 2-8 v0.41)
    'cmd.resume': '再開',
    'pause.receivedTitle': '中断の申し出',
    'pause.receivedBody': '相手が対局の一時中断を申し出ています。合意すると両者の時計が止まります。',
    'pause.acceptAction': '中断に同意',
    'pause.rejectAction': '中断を拒否',
    'pause.sentWaiting': '中断を申し出中… 相手の応答を待っています',
    'pause.rejectedByOpp': '相手が中断を拒否しました',
    'resume.receivedTitle': '再開の申し出',
    'resume.receivedBody': '相手が対局の再開を申し出ています。合意すると時計が再び進みます。',
    'resume.acceptAction': '再開に同意',
    'resume.rejectAction': '再開を拒否',
    'resume.sentWaiting': '再開を申し出中… 相手の応答を待っています',
