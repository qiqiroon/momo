...
export const ja: LocaleData = {
  ...
  translations: {
    ...
    's02.quantum': '量子将棋',
    's02.quantumNote': '全ての駒が量子状態（駒の種類が未確定）で始まり、駒を動かすことで観測され、駒の種類が確定していきます。',
    's02.quantumOff': 'OFF',
    's02.quantumOn': 'ON',
    ...
    'qmode.cycleDesc': '1秒ごとに候補が入れ替わる',
    'qmode.stackDesc': '候補を濃い字で重ね書き。読みにくい',
    ...
    's11.makeRoom.already-in-room': '対局の部屋にいます。先に退室してください',
    's11.roomSuffix': 'の感想戦',
    's11.roomWaiting': '部屋を作りました。相手を待っています',
    ...
    // ★段2: カスタムルールの定義をファイルから取り戻す（§9.2.6 ②）
    's08.ruleFile.title': 'ルール定義が必要です',
    's08.ruleFile.body': 'この棋譜のルールはアプリに入っていません。定義ファイルを選んでください。',
    's08.ruleFile.rule': 'ルール',
    's08.ruleFile.version': '版',
    's08.ruleFile.choose': '定義ファイルを選ぶ',
    's08.ruleFile.cancel': 'やめる',
    ...
    's08.ruleFile.rechoose': '別のファイルを選ぶ',
    's08.ruleFile.abort': '中止する',
    ...
    's08.sortRule': 'ルール',
    's08.sortResult': '結果',
    's08.formats': '読み込めるのは独自JSON（この将棋が書き出したファイル）です',
    's08.first': '先頭',
    's08.prev': '1手戻る',
    's08.auto': '自動',
    's08.stop': '停止',
    ...
    's08.moves': '棋譜',
    's08.start': '— 開始 —',
    's08.noKifu': '棋譜がありません。「棋譜一覧」から読み込んでください。',
    's08.oppCom': '対 AI',
    's08.oppNet': 'ネット対戦',
    's08.oppF2f': '同じ端末で二人',
    ...
    // 保存できたことの知らせ（親 v1.40 §9.2.3 ③）。本人が OK を押すまで残す。
    'kifu.saved.title': '棋譜を保存しました',
    'kifu.saved.titleUnverified': '棋譜を書き出しました',
    'kifu.saved.file': 'ファイル名',
    'kifu.saved.folder': '保存先',
    ...
    // ★v1.87: 点数は合計だけでなく式で出す (付録D-3 v1.11 §3.4)。
    // **語順は言語ごとに違う**ので、雛形の側を各言語が持ち、数だけを差し込む。
    'result.detail.formula': '大駒5点×{M}枚＋小駒1点×{m}枚（玉1枚を除く）＝{P}点',
    'result.detail.formulaNoKing': '大駒5点×{M}枚＋小駒1点×{m}枚＝{P}点',
    'result.detail.sideEntered': '{side}：入玉、{formula}',
    'result.detail.sideLine': '{side}：{formula}',
    // ★v1.87: 入玉宣言の 3 条件。終局画面では 3 つとも達成済みなので、
    // ここでの役目は「どう達成したのかを見せる」こと。
    'result.detail.condEntered': '入玉できている',
    'result.detail.condPieces': '敵陣内の駒数 {n}枚 ≥ {need}枚',
    ...
    'result.detail.scopeEnter': '敵陣内の駒＋持ち駒',
    ...
    // 手合い (駒落ち・Phase 3-3・付録 D-5 v1.3 §5)
    's03.lblHandicap': '手合い',
    's03.hcEven': '平手',
    's03.hcDrop': '駒落ち',
    's03.hcGiverAi': 'AI が落とす',
    's03.hcGiverYou': 'あなたが落とす',
    's03.hcLblType': '落とす駒',
    's03.hcNote': '駒を落とした側が不利になり、先手になります。',
    's03.hcUnsupported': 'このルールは駒落ちに対応していません（平手のみ）',
    's03.sideLocked': '駒落ちでは、駒を落とした側が先手になります',
    'hc.kyo': '香落ち',
    'hc.kaku': '角落ち',
    'hc.hi': '飛車落ち',
    'hc.ni': '二枚落ち',
    ...
    'anomaly.vote.desc': '不安定な状態ですが、両者が「継続」を選ぶと現在の状態のまま続行できます。どちらかが「ノーゲーム」を選ぶと対局は不成立になります。',
    'anomaly.btn.continue': '継続する',
    'anomaly.btn.nogame': 'ノーゲームにする',
    'anomaly.opp.choosing': '相手：選択中',
