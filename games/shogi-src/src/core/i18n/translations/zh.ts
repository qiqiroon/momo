...
export const zh: LocaleData = {
  ...
  translations: {
    ...
    'result.detail.zonePieces': '敌阵内棋子数（不含王）',
    'result.detail.zoneMajors': '敌阵内大子',
    'result.detail.sentePoints': '先手点数',
    'result.detail.gotePoints': '后手点数',
    'result.detail.scope': '计算范围',
    'result.detail.scopeJishogi': '盘上所有棋子＋持驹',
    'result.detail.countRule': '每枚的算法',
    'result.detail.countRuleValue': '大子5・小子1（不含王）',
