...
export const zh: LocaleData = {
  ...
  translations: {
    ...
    // 暂停・恢复 (阶段 2-8 v0.41)
    'cmd.resume': '恢复',
    'pause.receivedTitle': '暂停提议',
    'pause.receivedBody': '对手提议暂停对局。同意后双方时钟都会停止。',
    'pause.acceptAction': '同意暂停',
    'pause.rejectAction': '拒绝暂停',
    'pause.sentWaiting': '已提议暂停… 等待对方回应',
    'pause.rejectedByOpp': '对手拒绝了暂停',
    'resume.receivedTitle': '恢复提议',
    'resume.receivedBody': '对手提议恢复对局。同意后时钟将重新运行。',
    'resume.acceptAction': '同意恢复',
    'resume.rejectAction': '拒绝恢复',
    'resume.sentWaiting': '已提议恢复… 等待对方回应',
