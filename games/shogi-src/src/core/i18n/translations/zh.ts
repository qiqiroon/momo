...
export const zh: LocaleData = {
  ...
  translations: {
    ...
    's00.footDesc': 'MOMO Shogi 是一款可在浏览器中畅玩的免费将棋游戏。除本将棋外，还能体验棋盘边缘相连的环面棋盘，以及棋子身份尚未确定的量子将棋等新奇规则。支持联网对战与 AI 对战。无需注册、无需安装，打开浏览器即可畅玩。',
