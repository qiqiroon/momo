...
export const zh: LocaleData = {
  ...
  translations: {
    ...
    // v1.55: 观战 (S13)
    's13.head': '联网观战',
    's13.lead': '去看别人的对局。等人的房间和对局中的房间都可以进入。',
    's13.roomsHead': '可观战的房间',
    's13.roomsEmpty': '目前没有可观战的房间',
    's13.roomsOffline': '连接服务器后会显示可观战的房间列表',
    's13.watch': '观战',
    's13.badgeWaiting': '对局前',
    's13.badgePlaying': '对局中',
    's13.badgeEnded': '已结束',
    's13.specFull': '观战人数已满',
    's13.leave': '结束观战',
    // v1.59（阶段3）：是否随对局者移动到复盘房间，以及对局结束的通知。
    's13.migrateTitle': '复盘已开始',
    's13.migrateBody': '要继续观战吗？',
    's13.migrateEnter': '进入',
    's13.migrateLeave': '返回观战列表',
    ...
    // ★段2: 从文件取回自定义规则定义（§9.2.6 ②）
    's08.ruleFile.title': '需要规则定义',
    's08.ruleFile.body': '此棋谱的规则未内置于应用中。请选择其定义文件。',
    's08.ruleFile.rule': '规则',
    's08.ruleFile.version': '版本',
    's08.ruleFile.choose': '选择定义文件',
    's08.ruleFile.cancel': '取消',
    ...
    's08.ruleFile.rechoose': '选择其他文件',
    's08.ruleFile.abort': '中止',
    's08.empty': '还没有棋谱',
    ...
    'result.detail.sep': '・',
    'result.detail.remainingSente': '先手剩余棋子',
    'result.detail.remainingGote': '后手剩余棋子',
    'result.detail.winCondition': '胜利条件',
    // ★v1.87: 点数以算式呈现 (附录D-3 v1.11 §3.4)。
    'result.detail.formula': '大子5点×{M}枚＋小子1点×{m}枚（不含王1枚）＝{P}点',
    'result.detail.formulaNoKing': '大子5点×{M}枚＋小子1点×{m}枚＝{P}点',
    'result.detail.sideEntered': '{side}：入玉，{formula}',
    'result.detail.sideLine': '{side}：{formula}',
    'result.detail.condEntered': '已入玉',
    'result.detail.condPieces': '敌阵内棋子数 {n}枚 ≥ {need}枚',
    'result.detail.condPoints': '点数 {p}点 ≥ {need}点',
    'result.detail.condPointsMethod': '点数 {p}点 ≥ {need}点（{method}）',
    'result.detail.method.27point': '27点法',
    'result.detail.method.24point': '24点法',
    'result.detail.zoneMajors': '敌阵内大子',
    'result.detail.scope': '计算范围',
    'result.detail.scopeJishogi': '盘上所有棋子＋持驹',
    'result.detail.scopeEnter': '敌阵内棋子＋持驹',
    ...
    'jishogi.receivedTitle': '持将棋提议',
    'jishogi.receivedBody': '对手提议持将棋（和棋）。',
    'jishogi.acceptAction': '接受',
    'jishogi.rejectAction': '拒绝',
    'jishogi.sentWaiting': '已提议持将棋',
    'jishogi.spectatorNotice': '持将棋提议中',
    'draw.rejectedByOpp': '对手拒绝了和棋',
    'jishogi.notAgreed': '持将棋未达成',
