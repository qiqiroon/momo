 ...
 *   - 作 カスタムルール作成 (S09 ルール作成へ行く入口。**未実装・見た目のみ**。
 *     段A でここへ「読み込んで遊ぶ」画面を繋いだが、作る入口と遊ぶ入口は別なので戻した)
    ...
    <div className="stage" style={{ maxWidth: 600 }}>
      ...
      <div className="mode-list">
        ...
        <ModeRow
          ...
          desc={t('s00.mBuildD')}
          onClick={() => {
            // ★ここは**ルールを「作る」入口** (S09 ルール作成・仕様 §9.3)。**遊ぶための
            // 入口ではない** (2026-08-25 ユーザー指摘)。段A で「読み込んで遊ぶ」画面を
            // ここへ間借りさせたが、作る画面と遊ぶ画面は別物なので戻した。
