...
const ja: Dict = {
  ...
  'footer.desc':
    'MOMO Sudoku は、1×1 から 49×49 までの可変サイズの盤面をブラウザだけで遊べるパズルです。問題はあらかじめ作り溜めてあり、どれも解が1つに定まります。拡大縮小と拡大鏡で大きな盤面も読みやすく、候補メモ・取り消し・ヒントを備えています。アカウント登録もインストールも不要です。',
...
const en: Dict = {
  ...
  'footer.desc':
    'MOMO Sudoku is a browser puzzle with variable board sizes, from 1x1 up to 49x49. Every puzzle is prepared in advance and has exactly one solution. Zoom and a loupe keep large boards readable, and you get candidate notes, undo and hints. No account and no install needed.',
...
const zh: Dict = {
  ...
  'footer.desc':
    'MOMO Sudoku 是一款可在浏览器中直接游玩的可变尺寸数字谜题，盘面从 1×1 到 49×49。题目均为预先生成，且解唯一。缩放与放大镜让大盘面依然清晰，并提供候选笔记、撤销与提示功能。无需注册，无需安装。',
