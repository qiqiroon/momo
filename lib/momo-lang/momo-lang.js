...
//
//   v1.1: detect() を navigator.languages(希望言語の並び)対応に。多言語設定の取りこぼしを防ぐ。
//   設計:
...
(function () {
  ...
  function detect() {
    try {
      // 希望言語の並び(navigator.languages)を上から見て、最初に当たる ja/zh/en を採用。
      // 例: ['fr','zh','en'] → zh（第1希望が未対応でも次の希望を拾う＝多言語設定の取りこぼし防止）。
      // zh-CN/zh-TW/zh-HK 等はすべて zh（簡体字で代替。繁体字版は未提供）。
