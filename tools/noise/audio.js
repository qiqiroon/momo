// audio.js - MOMO Noise Audio Engine v0.03
'use strict';
...
const AudioEngine = (() => {
  ...
  async function startRecording() {
    ...
    // Start recording IMMEDIATELY — ondataavailable fires on stop too
    recorder.ondataavailable = e => { if (e.data && e.data.size > 0) chunks.push(e.data); };
    recorder.start(); // no timeslice = less latency, all data on stop
  }
